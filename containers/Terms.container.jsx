    ...
    <section className="md:min-h-[100vh] relative z-0 -mt-[100px] flex flex-col gap-[20px] py-[40px] px-[20px] bg-[#1D78F2] md:px-[60px] lg:px-[120px]  xl:px-[150px] 2xl:px-[200px]">
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          EliteApps.com. All intellectual property rights are reserved. You may
          access this from EliteApps.com for your own personal use, subject to
          the restrictions set in these terms and conditions. You must not:
          <ul className="list-disc">
            <li>Republish material from EliteApps.com</li>
            <li>Sell, rent, or sub-license material from EliteApps.com</li>
            <li>Reproduce, duplicate, or copy material from EliteApps.com</li>
            <li>Redistribute content from EliteApps.com</li>
          </ul>
          ...
          information in certain areas of the website. Elite Apps Technologies
          ...
          opinions of Elite Apps Technologies, its agents, and/or affiliates.
          Comments reflect the views and opinions of the person who posts their
          views and opinions. To the extent permitted by applicable laws, Elite
          Apps Technologies shall not be liable for the comments or for any
          ...
          website. Elite Apps Technologies reserves the right to monitor all
          comments and to remove any comments that can be considered
          ...
          <ul className="list-disc">
            ...
            <li>
              You hereby grant Elite Apps Technologies a non-exclusive license
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          <ul className="list-disc">
            ...
            <li>
              ...
              groups that may not hyperlink to our website.
            </li>
          </ul>
          ...
          <ul className="list-disc">
            ...
            <li>
              ...
              for the absence of Elite Apps Technologies
            </li>
            <li>The link is in the context of general resource informatione</li>
          </ul>
          These organizations may link to our home page as follows:
          <ul className="list-disc">
          ...
          No use of Elite Apps Technologies' logo or other artwork will be
