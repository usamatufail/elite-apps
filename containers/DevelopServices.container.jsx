          ...
          <div className="flex flex-col gap-[20px] font-body md:pr-[100px]">
            ...
            <Animate>
              <p className="text-[#545454] font-[400] font-body text-[16px]">
                ...
                experienced design & development team that offers businesses
                smart tech solutions. We are familiar with the latest
                technologies and offer our clients tech ideas to transform their
                businesses.
              </p>
            </Animate>
            <Animate>
