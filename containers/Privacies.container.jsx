    ...
    <section className="md:min-h-[100vh] relative z-0 -mt-[100px] flex flex-col gap-[20px] py-[40px] px-[20px] bg-[#1D78F2] md:px-[60px] lg:px-[120px]  xl:px-[150px] 2xl:px-[200px]">
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          provided below have the same meaning regardless of whether they appear
          in the singular or plural form.
          <br />
          "You" refers to the individual using the Service or accessing the
          Service on behalf of a company or other legal entity.
          <ul className="list-disc">
            <li>
              "Account" refers to the unique account created by you to access
              and use our Service.
            </li>
            <li>
              "Company," "We," "Us," or "Our" refers to Elite Apps Technologies.
            </li>
            <li>
              "Cookies" are small files placed on your computer, mobile device,
              or any other device by a website, containing details of your
              browsing history.
            </li>
            <li>"Country" refers to the country in which you reside.</li>
            "Device" refers to any device that can access the Service, such as a
            computer, cellphone, or tablet.
            <li>
              "Personal Data" refers to any information that relates to an
              identified or identifiable individual.
            </li>
            <li>"Service" refers to the website provided by EliteApps.com.</li>
            <li>
              "Service Provider" refers to any natural or legal person who
              processes data on behalf of Elite Apps Technologies.
            </li>
            <li>
              "Usage Data" refers to data collected automatically through the
              use of the Service, such as your IP address, browser type, and
              pages visited.
            </li>
            <li>
              "Website" refers to EliteApps.com, accessible from
              https://www.eliteapps.com/.
            </li>
          </ul>
        </p>
      </div>
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          which can be used to contact or identify you. This may include:
          <ul className="list-disc">
            <li>Email address</li>
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          <ul className="list-disc">
            ...
            <li>
              To send you newsletters, marketing communications, and other
              information about our products and services, unless you have opted
              not to receive such information
            </li>
            <li>To analyze usage data and improve our Service</li>
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          <br />
          <ul className="list-disc">
            <li>To service providers who assist us in providing the Service</li>
            <li>
              To comply with legal obligations or respond to valid requests from
              public authorities
            </li>
            <li>In connection with a merger, acquisition, or sale of assets</li>
            <li>
              To affiliates, business partners, or other third parties with whom
              we collaborate
            </li>
          </ul>
        </p>
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <p className="text-[#fff] font-[400] font-body text-[16px]">
          ...
          <br />
          Email: support@eliteapps.com
          <br />
          Website: https://www.eliteapps.com/
          <br />
          Please note that this Privacy Policy is a general reference and may
          need to be tailored to your specific use case. It is advisable to
          consult with legal professionals to ensure compliance with applicable
